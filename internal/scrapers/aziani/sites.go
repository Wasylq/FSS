...
var sites = []SiteConfig{
	{
		...
		MatchRe:   regexp.MustCompile(`^https?://(?:www\.)?aziani\.com(?:/|$)`),
	},
	{
		ID:        "2poles1hole",
		...
		MatchRe:   regexp.MustCompile(`^https?://(?:www\.)?2poles1hole\.com(?:/|$)`),
	},
	{
		ID:        "creampiled",
		...
		MatchRe:   regexp.MustCompile(`^https?://(?:www\.)?creampiled\.com(?:/|$)`),
	},
	{
		ID:        "popuporgies",
		...
		MatchRe:   regexp.MustCompile(`^https?://(?:www\.)?popuporgies\.com(?:/|$)`),
	},
}
