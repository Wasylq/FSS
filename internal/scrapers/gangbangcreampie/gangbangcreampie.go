...
var config = gammautil.SiteConfig{
	SiteID:     "gangbangcreampie",
	SiteBase:   "https://www.gangbangcreampie.com",
	StudioName: "Gangbang Creampie",
	SiteName:   "gangbangcreampie",
}
...
func (s *Scraper) Patterns() []string {
	return []string{"gangbangcreampie.com"}
}

var matchRe = regexp.MustCompile(`^https?://(?:www\.)?gangbangcreampie\.com`)
