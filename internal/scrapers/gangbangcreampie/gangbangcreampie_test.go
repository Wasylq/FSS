...
func TestMatchesURL(t *testing.T) {
	...
	cases := []struct {
		...
		{"https://www.gangbangcreampie.com", true},
		{"https://gangbangcreampie.com/en/videos", true},
		{"https://www.gangbangcreampie.com/en/video/gangbangcreampie/Some-Scene/12345", true},
...
func TestToScene(t *testing.T) {
	...
	scene := gammautil.ToScene(config, "https://www.gangbangcreampie.com", hit, now)

	if scene.ID != "100001" {
		t.Errorf("ID = %q", scene.ID)
	}
	if scene.SiteID != "gangbangcreampie" {
		t.Errorf("SiteID = %q", scene.SiteID)
	}
	if scene.URL != "https://www.gangbangcreampie.com/en/video/gangbangcreampie/Test-Scene/100001" {
		t.Errorf("URL = %q", scene.URL)
	}
	if scene.Studio != "Gangbang Creampie" {
...
func TestListScenes(t *testing.T) {
	hits := []gammautil.AlgoliaHit{
		{
			...
			Categories:  []gammautil.Category{{Name: "Creampie"}},
	...
	cfg := gammautil.SiteConfig{
		SiteID: "gangbangcreampie", SiteBase: ts.URL, StudioName: "Gangbang Creampie", SiteName: "gangbangcreampie",
	}
