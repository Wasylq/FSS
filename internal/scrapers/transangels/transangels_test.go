...
func TestMatchesURL(t *testing.T) {
	...
	cases := []struct {
		...
		{"https://www.transangels.com", true},
		{"https://transangels.com/pornstar/123/some-star", true},
		{"https://www.transangels.com/category/79/milf", true},
		{"https://www.transangels.com/site/96/some-site", true},
		{"https://www.transangels.com/series/1234/some-series", true},
		{"https://www.transangels.com/video/12345/some-video", true},
...
func TestListScenes(t *testing.T) {
	...
	cfg := ayloutil.SiteConfig{SiteID: "transangels", SiteBase: ts.URL, StudioName: "TransAngels"}
