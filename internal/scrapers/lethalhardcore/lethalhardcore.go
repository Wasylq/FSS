...
var config = gammautil.SiteConfig{
	SiteID:     "lethalhardcore",
	SiteBase:   "https://www.lethalhardcore.com",
	StudioName: "Lethal Hardcore",
	SiteName:   "lethalhardcore",
}
...
func (s *Scraper) Patterns() []string {
	return []string{"lethalhardcore.com"}
}

var matchRe = regexp.MustCompile(`^https?://(?:www\.)?lethalhardcore\.com`)
