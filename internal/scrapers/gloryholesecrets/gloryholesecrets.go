...
var config = gammautil.SiteConfig{
	SiteID:     "gloryholesecrets",
	SiteBase:   "https://www.gloryholesecrets.com",
	StudioName: "Gloryhole Secrets",
	SiteName:   "gloryholesecrets",
}
...
func (s *Scraper) Patterns() []string {
	return []string{"gloryholesecrets.com"}
}

var matchRe = regexp.MustCompile(`^https?://(?:www\.)?gloryholesecrets\.com`)
