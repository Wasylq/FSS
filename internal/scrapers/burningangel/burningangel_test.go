...
func TestMatchesURL(t *testing.T) {
	...
	cases := []struct {
		...
		{"https://www.burningangel.com", true},
		{"https://burningangel.com/en/videos", true},
		{"https://www.burningangel.com/en/video/burningangel/Some-Scene/12345", true},
...
func TestToScene(t *testing.T) {
	...
	scene := gammautil.ToScene(config, "https://www.burningangel.com", hit, now)

	if scene.ID != "100001" {
		t.Errorf("ID = %q", scene.ID)
	}
	if scene.SiteID != "burningangel" {
		t.Errorf("SiteID = %q", scene.SiteID)
	}
	if scene.URL != "https://www.burningangel.com/en/video/burningangel/Test-Scene/100001" {
		t.Errorf("URL = %q", scene.URL)
	}
	if scene.Studio != "Burning Angel" {
...
func TestListScenes(t *testing.T) {
	hits := []gammautil.AlgoliaHit{
		{
			...
			Categories:  []gammautil.Category{{Name: "Alt"}},
	...
	cfg := gammautil.SiteConfig{
		SiteID: "burningangel", SiteBase: ts.URL, StudioName: "Burning Angel", SiteName: "burningangel",
	}
