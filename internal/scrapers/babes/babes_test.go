...
func TestMatchesURL(t *testing.T) {
	...
	cases := []struct {
		...
		{"https://www.babes.com", true},
		{"https://babes.com/pornstar/123/some-star", true},
		{"https://www.babes.com/category/79/milf", true},
...
func TestListScenes(t *testing.T) {
	releases := []ayloutil.Release{
		{
			ID: 9001, Type: "scene", Title: "Babes Scene",
	...
	cfg := ayloutil.SiteConfig{SiteID: "babes", SiteBase: ts.URL, StudioName: "Babes"}
	...
	if len(results) != 1 || results[0].Title != "Babes Scene" {
...
func TestListScenesKnownIDs(t *testing.T) {
	releases := []ayloutil.Release{
		{ID: 10001, Type: "scene", Title: "New", DateReleased: "2026-02-01T12:00:00+00:00",
			RawImages: json.RawMessage(`[]`), RawVideos: json.RawMessage(`[]`)},
		{ID: 10002, Type: "scene", Title: "Known", DateReleased: "2026-01-01T12:00:00+00:00",
			RawImages: json.RawMessage(`[]`), RawVideos: json.RawMessage(`[]`)},
	}
	...
	if len(results) != 1 || results[0].ID != "10001" {
		t.Errorf("got scenes %v, want [10001]", results)
	}
}
