...
var sites = []titanmediautil.SiteConfig{
	{
		...
		Patterns: []string{"gloryholeswallow.com", "gloryholeswallow.com/tour/updates/page_{N}.html"},
	...
	},
	{
		...
		Patterns: []string{"cumclinic.com", "cumclinic.com/tour/updates/page_{N}.html"},
	...
	},
	{
		...
		Patterns: []string{"cumpsters.com", "cumpsters.com/updates/page_{N}.html"},
	...
	},
	{
		...
		Patterns: []string{"spytug.com", "spytug.com/updates/page_{N}.html"},
