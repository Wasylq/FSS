...
var sites = []natscmsutil.SiteConfig{
	{
		...
		MatchRe:   regexp.MustCompile(`^https?://(?:www\.|tour\.)?bearfilms\.com(?:/|$)`),
	},
	{
		ID:        "barebackcumpigs",
		...
		MatchRe:   regexp.MustCompile(`^https?://(?:www\.|tour\.)?barebackcumpigs\.com(?:/|$)`),
	},
	{
		ID:        "barebackthathole",
		...
		MatchRe:   regexp.MustCompile(`^https?://(?:www\.|tour\.)?barebackthathole\.com(?:/|$)`),
	},
	{
		ID:        "breedmeraw",
		...
		MatchRe:   regexp.MustCompile(`^https?://(?:www\.|tour\.)?breedmeraw\.com(?:/|$)`),
	},
	{
		ID:        "bringmeaboy",
		...
		MatchRe:   regexp.MustCompile(`^https?://(?:www\.|tour\.)?bringmeaboy\.com(?:/|$)`),
	},
	{
		ID:        "bulldogpit",
		...
		MatchRe:   regexp.MustCompile(`^https?://(?:www\.|tour\.)?bulldogpit\.com(?:/|$)`),
	},
	{
		ID:        "daddyontwink",
		...
		MatchRe:   regexp.MustCompile(`^https?://(?:www\.|tour\.)?daddyontwink\.com(?:/|$)`),
	},
	{
		ID:        "hairyandraw",
		...
		MatchRe:   regexp.MustCompile(`^https?://(?:www\.|tour\.)?hairyandraw\.com(?:/|$)`),
	},
	{
		ID:        "hardbritlads",
		...
		MatchRe:   regexp.MustCompile(`^https?://(?:www\.|tour\.)?hardbritlads\.com(?:/|$)`),
	},
	{
		ID:        "southernstrokes",
		...
		MatchRe:   regexp.MustCompile(`^https?://(?:www\.|tour\.)?southernstrokes\.com(?:/|$)`),
	},
	{
		ID:        "touchthatboy",
		...
		MatchRe:   regexp.MustCompile(`^https?://(?:www\.|tour\.)?touchthatboy\.com(?:/|$)`),
	},
	{
		ID:        "twinksinshorts",
		...
		MatchRe:   regexp.MustCompile(`^https?://(?:www\.|tour\.)?twinksinshorts\.com(?:/|$)`),
	},
}
