...
func TestMatchesURL(t *testing.T) {
	...
	cases := []struct {
		...
		{"https://www.roccosiffredi.com", true},
		{"https://roccosiffredi.com/en/videos", true},
		{"https://www.roccosiffredi.com/en/video/roccosiffredi/Some-Scene/12345", true},
...
func TestToScene(t *testing.T) {
	...
	scene := gammautil.ToScene(config, "https://www.roccosiffredi.com", hit, now)

	if scene.ID != "100001" {
		t.Errorf("ID = %q", scene.ID)
	}
	if scene.SiteID != "roccosiffredi" {
		t.Errorf("SiteID = %q", scene.SiteID)
	}
	if scene.URL != "https://www.roccosiffredi.com/en/video/roccosiffredi/Test-Scene/100001" {
		t.Errorf("URL = %q", scene.URL)
	}
	if scene.Studio != "Rocco Siffredi" {
...
func TestListScenes(t *testing.T) {
	...
	cfg := gammautil.SiteConfig{
		SiteID: "roccosiffredi", SiteBase: ts.URL, StudioName: "Rocco Siffredi", SiteName: "roccosiffredi",
	}
