...
func (s *Scraper) ID() string { return "moodyz" }
...
var matchRe = regexp.MustCompile(`^https?://(?:www\.)?moodyz\.com/(?:works/list/|actress/detail/)`)
...
func buildDetailURL(studioURL, code string) string {
	...
	if err != nil {
		return "https://moodyz.com/works/detail/" + code
	}
